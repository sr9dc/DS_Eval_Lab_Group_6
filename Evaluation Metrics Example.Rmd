...
loan_data <- read_csv('japan_credit.csv')
#Take a look
View(loan_data)
str(loan_data)
...
loan_eval <- data.frame(pred_class=loan_eval, pred_prob=loan_eval_prob$`1`,target=as.numeric(test$outcome))
...
F1_Score(as.numeric(loan_eval$pred_class.pred_class),as.numeric(test$outcome))
