...
iris_pred <- class::knn(train = iris_training, test = iris_test, cl=iris.trainLabels, k=3, prob = TRUE)
...
cf <- caret::confusionMatrix(iris_pred, iris_test_car$Species)
